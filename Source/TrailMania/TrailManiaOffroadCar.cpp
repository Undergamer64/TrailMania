...
#include "TrailManiaOffroadCar.h"
#include "TrailManiaOffroadWheelFront.h"
#include "TrailManiaOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ATrailManiaOffroadCar::ATrailManiaOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrailManiaOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrailManiaOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrailManiaOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrailManiaOffroadWheelRear::StaticClass();
