...
#include "TrailManiaPlayerController.generated.h"

class UInputMappingContext;
class ATrailManiaPawn;
class UTrailManiaUI;
 ...
 */
UCLASS(abstract)
class TRAILMANIA_API ATrailManiaPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ATrailManiaPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UTrailManiaUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UTrailManiaUI> VehicleUI;
