...
#include "TrailManiaSportsCar.h"
#include "TrailManiaSportsWheelFront.h"
#include "TrailManiaSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATrailManiaSportsCar::ATrailManiaSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrailManiaSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrailManiaSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrailManiaSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrailManiaSportsWheelRear::StaticClass();
